...
> <code><var>target</var></code></dfn> (an empty object here) and a <dfn
> <code><var>handler</var></code></dfn> object, in which a `get` <dfn>trap</dfn>
> is implemented. Here, an object that is proxied will not return `undefined`
